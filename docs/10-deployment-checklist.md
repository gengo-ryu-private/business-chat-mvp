...
- [ ] トップページから認証状態に応じて適切な画面へ遷移する
- [ ] Route Handler を通じて新規テナント作成でユーザー登録できる
- [ ] 登録後にチャンネル一覧画面へ遷移する
- [ ] 管理者ユーザーがチャンネルを作成できる
- [ ] 管理者ユーザーが参加コードを確認できる
- [ ] Route Handler を通じて参加コードで一般ユーザーが既存テナントに参加できる
- [ ] 一般ユーザーにチャンネル作成ボタンが表示されない
- [ ] 一般ユーザーに参加コードが表示されない
- [ ] チャンネル詳細画面でメッセージを投稿できる
- [ ] 投稿したメッセージが一覧に表示される
- [ ] 同じチャンネルの新しい投稿が画面更新なしで反映される
- [ ] ログアウトできる
- [ ] 未ログイン状態で認証後画面へアクセスできない
- [ ] 所属テナント外のデータへアクセスできない
- [ ] エラー時に画面上で分かるメッセージが表示される
